...
public class LivroDao {
    ...
    public int insert(Livro livro) {
        ...
        long student_Id = db.insert(Livro.TABLE, null, values);
        db.close();
    ...
    public ArrayList<HashMap<String, String>> getLivroList() {
        ...
        if (cursor.moveToFirst()) {
            do {
                ...
                student.put("id", cursor.getString(cursor.getColumnIndexOrThrow(Livro.KEY_ID)));
                student.put("name", cursor.getString(cursor.getColumnIndexOrThrow(Livro.KEY_nome)));
                livrolista.add(student);
